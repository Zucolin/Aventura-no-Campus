...
<audio id="som-fundo" src="sound/MUSIC.mp3" loop autoplay></audio>
  ...
  <div id="caixa-mensagem1" class="mensagem-fabio">
    ...
    <span class="msg-text">FABIO: Eae Vitor, estou com problema urgente aqui, mecheram no meu computador</span>
  </div>

  <div id="caixa-mensagem2" class="mensagem-fabio">
    <span class="msg-avatar5"></span>
    <span class="msg-text">FABIO: Suspeito terem usado uma linguagem de símbolos já existente, agora para eu poder
      mecher, tenho que saber essa linguagem</span>
  </div>
  ...
  <div id="caixa-mensagem4" class="mensagem-fabio">
    ...
    <span class="msg-text">VITOR: Que coincidência incrivel.. coincidência de jogo isso!!! O livro que achei tem
      envolvimento com seu computador </span>
  </div>
